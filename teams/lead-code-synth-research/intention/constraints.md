...
- The Human Operator may define workflow, supply references, approve constraints, redirect search, and accept or reject terminal results.
...
- Accepted candidates need reproducible evidence: correctness command, benchmark command, timing summary, changed files, candidate id, and comparison to the previous best.
...
- Agents should stop and escalate when repeated failures show the current direction is exhausted, the benchmark appears exploitable, or workspace state becomes inconsistent.
