# Project Skillset Layout Specification

## Purpose

Define the repository-local skill directory layout and the intended audience boundary between development skills and runtime CUDA optimization skills.
